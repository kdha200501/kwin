...
void XdgToplevelWindow::setNextMaximizeHorizontalGeometry(RectF &nextGeometry, const RectF &clientArea, MaximizeMode nextMaximizeMode)
{
...
void XdgToplevelWindow::setNextMaximizeVerticalGeometry(RectF &nextGeometry, const RectF &clientArea, MaximizeMode nextMaximizeMode)
{
    // if the window is to be maximized
...
void XdgToplevelWindow::maximize(MaximizeMode nextMaximizeMode, const RectF &restore)
{
    ...
    RectF nextMaximizeGeometry = oldGeometry;
